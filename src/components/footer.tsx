const Footer = () => {
  return (
    <footer className="ml-80 flex flex-col border-t border-gray-200 px-8 py-4 shadow-sm">
      <span className="font-medium text-gray-600">&copy; William Andrés Aguirre · 2026</span>
